        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
          ...
          <Card className="overflow-hidden border-wedding-gold/20 hover:shadow-xl transition-all duration-300">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                Mahesh is the eldest son of Mr. Venkateshwarlu and Mrs. Lakshmi. Born and raised in Hyderabad, he completed his education in Computer Science and now works as a Software Engineer at a leading tech company. His calm demeanor, intelligence, and compassionate nature make him beloved by family and friends alike.
              </p>
          ...
          <Card className="overflow-hidden border-wedding-gold/20 hover:shadow-xl transition-all duration-300">
            ...
            <CardContent className="p-6">
              ...
              <p className="text-gray-700 mb-4">
                Powshya is the beloved daughter of Mr. Ramakrishna and Mrs. Saraswati. Growing up in a traditional Telugu household, she has always valued her cultural roots. She holds a Master's degree in Business Administration and works as a Marketing Manager at a multinational corporation.
              </p>
              <p className="text-gray-700">
